...
<div class="row-fluid">
	...
	<div class="span9">
		...
		<g:hasErrors bean="${testing2Instance}">
			<bootstrap:alert class="alert-error">
				<ul>
					<g:eachError bean="${testing2Instance}" var="error">
		...
		<fieldset>
			<g:form class="form-horizontal" url="[resource:testing2Instance, action:'update']" method="PUT" >
			<g:hiddenField name="version" value="${testing2Instance?.version}" />
			<fieldset>
