	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<g:if test="${categoryInstance?.helpText}">
				<li class="fieldcontain">
					<span id="helpText-label" class="property-label"><g:message code="category.helpText.label" default="Help Text" /></span>
					
						<span class="property-value" aria-labelledby="helpText-label"><g:fieldValue bean="${categoryInstance}" field="helpText"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${categoryInstance?.displayOrder}">
				<li class="fieldcontain">
					<span id="displayOrder-label" class="property-label"><g:message code="category.displayOrder.label" default="Display Order" /></span>
					
						<span class="property-value" aria-labelledby="displayOrder-label"><g:fieldValue bean="${categoryInstance}" field="displayOrder"/></span>
